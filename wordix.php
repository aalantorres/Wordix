<?php
include_once("programaTorresRosas.php");
...
/**
 *  Permite ingresar un numero entre un rango de valores ya sea para jugar o mostrar un partida y retorna el numero si es valido entre ese rango
 * @param int $min
 * @param int $max
 * @return int
 */
...
/**
 *  Funcion que permite ingresar una palabra de 5 letras y retorna la palabra, en caso de que se ingrese de que no sean 5 letras se volvera a pedir
...
/**
 * Ingresa una palabra y los intentos en la que se adivino para calcular el puntaje total de una persona y lo retorna
 * @param string $palabra
 * @param int $intentos
 * @return int
 */
function obtenerPuntajeWordix($palabra, $intentos)  /* ****COMPLETAR***** parámetros formales necesarios */
{
    $puntajeTotal = 0;
    for ($i = 0; $i <strlen($palabra); $i++){
        $puntajeTotal = $puntajeTotal + PuntosAbecedario($palabra[$i]);
    }
    switch ($intentos) {
        case 1:
